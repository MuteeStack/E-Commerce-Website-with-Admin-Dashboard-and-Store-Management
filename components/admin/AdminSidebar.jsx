...
import { HomeIcon, ShieldCheckIcon, StoreIcon, TicketPercentIcon, MessageSquareIcon } from "lucide-react"
    ...
    return (
        <div className="inline-flex h-full flex-col gap-5 border-r border-slate-200 sm:min-w-60">
            <div className="flex flex-col gap-3 justify-center items-center pt-8 max-sm:hidden">
                {user?.image ? (
                    <img className="w-14 h-14 rounded-full object-cover" src={user.image} alt="" />
                ) : (
                    <div className="w-14 h-14 rounded-full bg-teal-500 flex items-center justify-center text-white text-2xl font-medium">
